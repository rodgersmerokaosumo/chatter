...
class ChatScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: const [
          Expanded(child: _DemoMesssageList()),
          Padding(
...
class _DemoMesssageList extends StatelessWidget {
  const _DemoMesssageList({Key? key}) : super(key: key);
    ...
    return Padding(
      ...
      child: ListView(
        children: const [
          ...
          _MessageTile(
            message: "Hi, I'm Rodgers",
            messageDate: "12:01 pm",
          ),
          _MessageOwnTile(
            message: "Hi, Rodgers from Warwick",
          ...
          _MessageOwnTile(
            message: "Been Good cannot complain",
            messageDate: "12:02 pm",
          ),
        ],
      ),
